...
@TeleOp
public class FraserDriveV3_Solo extends OpMode{
    ...
    public void loop(){
        ...
        telemetry.addLine("Hold dpad left and dpad right to raise and lower sensitivity; Sensitivity: " + String.format("%.2g%n", sensitivity));
        ...
        S1.setPower((gamepad1.left_trigger - gamepad1.right_trigger) * -0.4);
        S2.setPower((gamepad1.left_trigger - gamepad1.right_trigger) * 0.4);
        if (gamepad1.dpad_up){
