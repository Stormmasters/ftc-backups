...
@TeleOp
public class FraserDriveV2_2 extends OpMode{
    double LX, LY, RX, sensitivity = 0.5;
    DcMotor BL, FL, FR, BR, S1, S2;
    private DcMotor Shoulder;
    private Servo Elbow;
    private Servo Wrist;
    private Servo Intake, V;
    double w = 0;
    ...
    public void init(){
        ...
        V = hardwareMap.get(Servo.class, "Viper");
        V.setPosition(0);
    }
    @Override
    public void loop(){
        ...
        Shoulder.setPower(gamepad2.left_stick_y * 0.3);
        ...
        if (gamepad2.left_bumper){
            V.setPosition(V.getPosition() + 0.002);
        }
