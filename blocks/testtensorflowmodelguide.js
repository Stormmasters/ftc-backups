 ...
 */
function runOpMode() {
  vuforiaCurrentGameAccess.initialize_withCameraDirection_2("BACK", false, false, "NONE", 0, 0, 0, "XYZ", 0, -90, 0, true);
  ...
  tfodAccess.useModelFromFile('YourCustomModel.tflite', JSON.stringify(['ball']), true, true, 320);
